...
// 進捗データを保存
$sql = "
INSERT INTO y_progress (student_id, test_id, week, english, math, science, social, japanese) 
VALUES ((SELECT student_id FROM student WHERE student = ?), (SELECT test_id FROM tests WHERE test_name = ?), ?, ?, ?, ?, ?, ?)
";
